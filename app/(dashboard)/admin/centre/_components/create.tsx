...
import { useCentreForm } from "@/lib/hooks/centre.hook";
import { Loader2 } from "lucide-react";
import { CreateCentreDTO } from "@/lib/DTO/centre.dto";
...
export default function CreateCentre({ open, onOpenChange }: CreateCentreProps) {
  ...
  const { form, onSubmit, isLoading } = useCentreForm();
  ...
  const handleSubmit = async (data: CreateCentreDTO) => {
    await onSubmit(data);
    onOpenChange(false);
  };
