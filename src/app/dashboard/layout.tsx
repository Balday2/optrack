...
import XDashboardCard from "@/components/x-dashboard";
...
import XPieChart from "@/components/x-piechart";
import XDashboard from "@/components/x-dashboard";
  ...
  return (
    ...
    >
      <div className="flex flex-col sm:gap-4 sm:py-4 sm:px-20">
        <XHeader />
        <main className="grid flex-1 items-start gap-1 pt-4 sm:px-6 sm:py-0 md:gap-8">
              ...
              <div className="flex gap-3 pb-2 font-light">
                <Link
                  ...
                  className={`px-2 text-lg ${
                    path.includes("daily-operation") &&
                    "border border-primary bg-gray-200 "
                  }`}
                >
